//! Agent hyperparameter tuning application.
//!
//! Provides utilities for optimizing agent configurations using
...
/// An agent configuration: maps parameter names to values.
#[derive(Debug, Clone, Serialize, Deserialize)]
...
/// Tune agent hyperparameters by minimizing an objective function.
///
...
mod tests {
    ...
    #[test]
    fn test_agent_config_vector_roundtrip() {
        let hyperparams = vec![
